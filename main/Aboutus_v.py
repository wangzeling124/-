...
# 注册接口
@main_bp.route("/pythoni2v8cf2c/aboutus/register", methods=['POST'])
def pythoni2v8cf2c_aboutus_register():
...
# 登录接口
@main_bp.route("/pythoni2v8cf2c/aboutus/login", methods=['GET','POST'])
def pythoni2v8cf2c_aboutus_login():
...
# 登出接口
@main_bp.route("/pythoni2v8cf2c/aboutus/logout", methods=['POST'])
def pythoni2v8cf2c_aboutus_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythoni2v8cf2c/aboutus/resetPass", methods=['POST'])
def pythoni2v8cf2c_aboutus_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/pythoni2v8cf2c/aboutus/session", methods=['GET'])
def pythoni2v8cf2c_aboutus_session():
...
# 分类接口（后端）
@main_bp.route("/pythoni2v8cf2c/aboutus/page", methods=['GET'])
def pythoni2v8cf2c_aboutus_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/pythoni2v8cf2c/aboutus/autoSort", methods=['GET'])
def pythoni2v8cf2c_aboutus_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/pythoni2v8cf2c/aboutus/query", methods=['GET'])
def pythoni2v8cf2c_aboutus_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythoni2v8cf2c/aboutus/list", methods=['GET'])
def pythoni2v8cf2c_aboutus_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/pythoni2v8cf2c/aboutus/save", methods=['POST'])
def pythoni2v8cf2c_aboutus_save():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 添加接口（前端）
@main_bp.route("/pythoni2v8cf2c/aboutus/add", methods=['POST'])
def pythoni2v8cf2c_aboutus_add():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 踩、赞接口
@main_bp.route("/pythoni2v8cf2c/aboutus/thumbsup/<id_>", methods=['GET'])
def pythoni2v8cf2c_aboutus_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/pythoni2v8cf2c/aboutus/info/<id_>", methods=['GET'])
def pythoni2v8cf2c_aboutus_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        ...
        if __browseClick__  and  "clicknum"  in aboutus.__table__.columns:
            ...
            ret=aboutus.updatebyparams(aboutus,aboutus,click_dict)#更新记录
            if ret!=None:
                msg['code'] = crud_error_code
                msg['msg'] = ret
        return jsonify(msg)
...
# 获取详情信息（前端）
@main_bp.route("/pythoni2v8cf2c/aboutus/detail/<id_>", methods=['GET'])
def pythoni2v8cf2c_aboutus_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = aboutus.getbyid(aboutus, aboutus, int(id_))
...
# 更新接口
@main_bp.route("/pythoni2v8cf2c/aboutus/update", methods=['POST'])
def pythoni2v8cf2c_aboutus_update():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #如果存在密码或点击次数则不更新
...
# 删除接口
@main_bp.route("/pythoni2v8cf2c/aboutus/delete", methods=['POST'])
def pythoni2v8cf2c_aboutus_delete():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #删除记录
...
# 投票接口
@main_bp.route("/pythoni2v8cf2c/aboutus/vote/<int:id_>", methods=['POST'])
def pythoni2v8cf2c_aboutus_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= aboutus.getbyid(aboutus, aboutus, int(id_))
...
#获取所有记录列表
@main_bp.route("/pythoni2v8cf2c/aboutus/lists", methods=['GET'])
def pythoni2v8cf2c_aboutus_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
