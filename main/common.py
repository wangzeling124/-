...
def before_request():
    ...
    if request.method == 'GET':
        ...
        post_list = [
            '/pythoni2v8cf2c/defaultuser/register',
            '/pythoni2v8cf2c/defaultuser/login',
            '/pythoni2v8cf2c/users/register',
            '/pythoni2v8cf2c/users/login',
            "/pythoni2v8cf2c/examusers/login" ,
            "/pythoni2v8cf2c/examusers/register"
        ]  # 免认证list
