...
# 注册接口
@main_bp.route("/pythoni2v8cf2c/systemintro/register", methods=['POST'])
def pythoni2v8cf2c_systemintro_register():
...
# 登录接口
@main_bp.route("/pythoni2v8cf2c/systemintro/login", methods=['GET','POST'])
def pythoni2v8cf2c_systemintro_login():
...
# 登出接口
@main_bp.route("/pythoni2v8cf2c/systemintro/logout", methods=['POST'])
def pythoni2v8cf2c_systemintro_logout():
    if request.method == 'POST':#post请求
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/pythoni2v8cf2c/systemintro/resetPass", methods=['POST'])
def pythoni2v8cf2c_systemintro_resetpass():
    if request.method == 'POST':#post请求
...
# 获取会话信息接口
@main_bp.route("/pythoni2v8cf2c/systemintro/session", methods=['GET'])
def pythoni2v8cf2c_systemintro_session():
...
# 分类接口（后端）
@main_bp.route("/pythoni2v8cf2c/systemintro/page", methods=['GET'])
def pythoni2v8cf2c_systemintro_page():
    if request.method == 'GET':#get请求
...
# 排序接口
@main_bp.route("/pythoni2v8cf2c/systemintro/autoSort", methods=['GET'])
def pythoni2v8cf2c_systemintro_autosort():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
#查询单条数据
@main_bp.route("/pythoni2v8cf2c/systemintro/query", methods=['GET'])
def pythoni2v8cf2c_systemintro_query():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{}}
        #获取传递的参数，根据参数获取单条结果
        req_dict = session.get("req_dict")
...
# 分页接口（前端）
@main_bp.route("/pythoni2v8cf2c/systemintro/list", methods=['GET'])
def pythoni2v8cf2c_systemintro_list():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 保存接口（后端）
@main_bp.route("/pythoni2v8cf2c/systemintro/save", methods=['POST'])
def pythoni2v8cf2c_systemintro_save():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取传递的参数
        req_dict = session.get("req_dict")
...
# 添加接口（前端）
@main_bp.route("/pythoni2v8cf2c/systemintro/add", methods=['POST'])
def pythoni2v8cf2c_systemintro_add():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #获取参数
        req_dict = session.get("req_dict")
...
# 踩、赞接口
@main_bp.route("/pythoni2v8cf2c/systemintro/thumbsup/<id_>", methods=['GET'])
def pythoni2v8cf2c_systemintro_thumbsup(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        id_=int(id_)
...
# 获取详情信息（后端）
@main_bp.route("/pythoni2v8cf2c/systemintro/info/<id_>", methods=['GET'])
def pythoni2v8cf2c_systemintro_info(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
...
# 获取详情信息（前端）
@main_bp.route("/pythoni2v8cf2c/systemintro/detail/<id_>", methods=['GET'])
def pythoni2v8cf2c_systemintro_detail(id_):
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        #根据id获取对应记录
        data = systemintro.getbyid(systemintro, systemintro, int(id_))
...
# 更新接口
@main_bp.route("/pythoni2v8cf2c/systemintro/update", methods=['POST'])
def pythoni2v8cf2c_systemintro_update():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #如果存在密码或点击次数则不更新
...
# 删除接口
@main_bp.route("/pythoni2v8cf2c/systemintro/delete", methods=['POST'])
def pythoni2v8cf2c_systemintro_delete():
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        #删除记录
...
# 投票接口
@main_bp.route("/pythoni2v8cf2c/systemintro/vote/<int:id_>", methods=['POST'])
def pythoni2v8cf2c_systemintro_vote(id_):
    if request.method == 'POST':#post请求
        msg = {"code": normal_code, "msg": "success"}
        #根据id获取记录
        data= systemintro.getbyid(systemintro, systemintro, int(id_))
...
#获取所有记录列表
@main_bp.route("/pythoni2v8cf2c/systemintro/lists", methods=['GET'])
def pythoni2v8cf2c_systemintro_lists():
    if request.method == 'GET':#get请求
        msg = {"code": normal_code, "msg": "success", "data": []}
